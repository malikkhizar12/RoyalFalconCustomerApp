...
class ConfirmBookingHalfDayBottomSheet {
  final List<Map<String, dynamic>> vehicles;

  ConfirmBookingHalfDayBottomSheet({required this.vehicles});
                        ...
                        child: Column(
                          ...
                          children: vehicles.map((vehicle) {
                            return ChangeNotifierProvider(
                              create: (_) => VehicleCardViewModel(initialPrice: vehicle['price'], defaultHours:5, bookingType: BookingType.halfDay),
